...
$ultimadata='';
$query = "SELECT vencimento from despesa WHERE vencimento > '".date('Y/m/d',$td)."' GROUP BY vencimento ORDER BY vencimento";
...
echo"
        ...
        var options = {
          ...
          colors:['#dc3912'], //altera cor da linha
